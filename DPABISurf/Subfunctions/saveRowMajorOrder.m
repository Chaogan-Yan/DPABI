function save(this,filename,encoding,ArrayIndexingOrder)
...
% ArrayIndexingOrder - 'ColumnMajorOrder' or 'RowMajorOrder'. 
%                      Default is 'ColumnMajorOrder'. 
%                      But freesurfer needs 'RowMajorOrder' %YAN Chao-Gan, 221208
...
% Revised by YAN Chao-Gan, 221208. ArrayIndexingOrder could be saved as
% 'RowMajorOrder', as freesurfer needs 'RowMajorOrder'.


if ~exist('ArrayIndexingOrder','var') %YAN Chao-Gan, 221208
...
fid = save_gii(fid,this,encoding,ArrayIndexingOrder);
...
%==========================================================================
function fid = save_gii(fid,this,encoding,ArrayIndexingOrder)
...
for i=1:length(this.data)
    ...
    this.data{i}.attributes.ArrayIndexingOrder = ArrayIndexingOrder; %YAN Chao-Gan, 221208 %this.data{i}.attributes.ArrayIndexingOrder = 'ColumnMajorOrder';
...
for i=1:length(this.data)
    ...
    if strcmpi(ArrayIndexingOrder,'ColumnMajorOrder') %YAN Chao-Gan, 221208
        switch this.data{i}.attributes.Encoding
            case 'ASCII'
    ...
    else % freesurfer needs 'RowMajorOrder' %YAN Chao-Gan, 221208
        switch this.data{i}.attributes.Encoding
            case 'ASCII'
                fprintf(fid, [tp.format ' '], this.data{i}.data');
            case 'Base64Binary'
