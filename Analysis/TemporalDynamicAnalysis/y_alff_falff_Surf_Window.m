function [ALFFBrain_AllWindow, fALFFBrain_AllWindow, Header] = y_alff_falff_Surf_Window(WindowSize, WindowStep, WindowType, AllVolume,ASamplePeriod, HighCutoff, LowCutoff, AMaskFilename, AResultFilename, TemporalMask, ScrubbingMethod, Header, CUTNUMBER)
