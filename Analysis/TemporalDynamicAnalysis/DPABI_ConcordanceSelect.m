function varargout = DPABI_ConcordanceSelect(varargin)
...
for iMeasure=1:length(Sep)-1
    ...
    switch Measure
        ...
        case 'VMHC'
            set(handles.checkboxVMHC, 'Value', 1);
        case 'DC'
...
if get(handles.checkboxVMHC,'Value');
    MeasuresSelected=[MeasuresSelected,'VMHC;'];
end
