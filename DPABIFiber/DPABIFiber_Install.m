...
%
%      DPABIFIBER_INSTALL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DPABIFIBER_INSTALL.M with the given input arguments.
%
%      DPABIFIBER_INSTALL('Property','Value',...) creates a new DPABIFIBER_INSTALL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DPABIFiber_Install_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DPABIFiber_Install_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DPABIFiber_Install

% Last Modified by GUIDE v2.5 27-Dec-2022 11:23:45

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DPABIFiber_Install_OpeningFcn, ...
                   'gui_OutputFcn',  @DPABIFiber_Install_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DPABIFiber_Install is made visible.
function DPABIFiber_Install_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DPABIFiber_Install (see VARARGIN)

% Choose default command line output for DPABIFiber_Install
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DPABIFiber_Install wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DPABIFiber_Install_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in pushbutton_PullDPABIFiberDocker.
function pushbutton_PullDPABIFiberDocker_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_PullDPABIFiberDocker (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
if strcmpi(button,'Pull from online docker hub')
    system('docker pull cgyan/dpabifiber')
else
