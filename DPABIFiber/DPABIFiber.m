...
fprintf('-----------------------------------------------------------\n');
fprintf('Citing Information:\nDPABIFiber is a fiber tractography analysis toolbox based on diffusion-weighted imaging (DWI), evolved from DPABI/DPABISurf/DPABINet/DPARSF, as easy-to-use as DPABI/DPABISurf/DPABINet/DPARSF. DPABIFiber is based on QSIPrep (Cieslak et al., 2021), MRtrix3 (Tournier et al., 2019),  fMRIPprep (Esteban et al., 2019), FreeSurfer (Dale et al., 1999), ANTs (Avants et al., 2008), FSL (Jenkinson et al., 2002), SPM12 (Ashburner, 2012), PALM (Winkler et al., 2016), GNU Parallel (Tange, 2011), MATLAB (The MathWorks Inc., Natick, MA, US), Docker (https://docker.com) and DPABI (Yan et al., 2016). DPABIFiber provides user-friendly graphical user interface (GUI) for pipeline DWI preprocessing, fiber tractography reconstruction,  tract-based spatial statistics, structural connectome matrix analyses,  seed based structural connectivity analyses, while requires no programming/scripting skills from the users.\n');
