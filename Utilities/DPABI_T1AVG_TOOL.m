function varargout = DPABI_T1AVG_TOOL(varargin)
% DPABI_T1AVG_TOOL MATLAB code for DPABI_T1AVG_TOOL.fig
%      DPABI_T1AVG_TOOL, by itself, creates a new DPABI_T1AVG_TOOL or raises the existing
%      singleton*.
%
%      H = DPABI_T1AVG_TOOL returns the handle to a new DPABI_T1AVG_TOOL or the handle to
%      the existing singleton*.
%
%      DPABI_T1AVG_TOOL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DPABI_T1AVG_TOOL.M with the given input arguments.
%
%      DPABI_T1AVG_TOOL('Property','Value',...) creates a new DPABI_T1AVG_TOOL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DPABI_T1AVG_TOOL_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DPABI_T1AVG_TOOL_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DPABI_T1AVG_TOOL

% Last Modified by GUIDE v2.5 22-Aug-2014 20:57:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DPABI_T1AVG_TOOL_OpeningFcn, ...
                   'gui_OutputFcn',  @DPABI_T1AVG_TOOL_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DPABI_T1AVG_TOOL is made visible.
function DPABI_T1AVG_TOOL_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DPABI_T1AVG_TOOL (see VARARGIN)
handles.SubjString=[];
% Choose default command line output for DPABI_T1AVG_TOOL
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DPABI_T1AVG_TOOL wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DPABI_T1AVG_TOOL_OutputFcn(hObject, eventdata, handles) 
