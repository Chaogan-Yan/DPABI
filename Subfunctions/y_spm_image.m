    ...
    switch i
        case 1
            st.QCScoreWidget{i} = uicontrol(fg, 'Style', 'Radiobutton', 'Position', [350 320-30*i 200 30].*WS,...
                'String', sprintf('1 - Very Poor'), 'Callback', @ QCScoreCallback, 'Value', 0);
        case 2
            st.QCScoreWidget{i} = uicontrol(fg, 'Style', 'Radiobutton', 'Position', [350 320-30*i 200 30].*WS,...
                'String', sprintf('2 - Poor'), 'Callback', @ QCScoreCallback, 'Value', 0);
        case 3
            st.QCScoreWidget{i} = uicontrol(fg, 'Style', 'Radiobutton', 'Position', [350 320-30*i 200 30].*WS,...
                'String', sprintf('3 - Fair'), 'Callback', @ QCScoreCallback, 'Value', 0);
        case 4
            st.QCScoreWidget{i} = uicontrol(fg, 'Style', 'Radiobutton', 'Position', [350 320-30*i 200 30].*WS,...
                'String', sprintf('4 - Good'), 'Callback', @ QCScoreCallback, 'Value', 0);
        case 5
            st.QCScoreWidget{i} = uicontrol(fg, 'Style', 'Radiobutton', 'Position', [350 320-30*i 200 30].*WS,...
                'String', sprintf('5 - Very Good'), 'Callback', @ QCScoreCallback, 'Value', 1);
    end
end
...
st.QCCommentWidget = uicontrol(fg, 'Style', 'edit', 'Position',[310 30 270 100].*WS,...
    'Max', 10, 'HorizontalAlignment', 'left', 'BackgroundColor', 'White');
