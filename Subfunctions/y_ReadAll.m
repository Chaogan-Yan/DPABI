...
%function [Data, VoxelSize, FileList, Header] = y_ReadAll(InputName)
% Read NIfTI or GIfTI files in all kinds of input formats.
% ------------------------------------------------------------------------
% Input:
...
% VoxelSize - the voxel size. It would be empty when reading GIfTI files
...
VoxelSize=[]; %YAN Chao-Gan 181204. It would be empty when reading GIfTI files
